...
class Trial2Spider(scrapy.Spider):
    name = 'trial2'
    #allowed_domains = ['www.sephora.com']
    #start_urls = ['https://www.sephora.com/shop/cleanser?currentPage=1']

    def start_requests(self):
        max_page=8
        urls=[]
        for num in range(1,max_page+1):
            url_new= f'https://www.sephora.com/shop/cleanser?currentPage={num}'
            urls.append(url_new)
        
        print('____________________)_START_REQUESTS - PAGES TO OPEN ARE: ', urls)
        ...
        for link in urls:
            ...
            print('__________________SENDING SELENIUMREQUEST FOR WEBPAGE:', link, '______________________')
    ...
    def parse(self, response):
        ...
        print("____________________CURRENT URL IS: ", driver.current_url, "__________________________")
