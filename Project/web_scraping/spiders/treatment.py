...
class TreatmentSpider(scrapy.Spider):
    name = 'treatment'
    ...
    start_urls = [
        'https://www.sephora.com/shop/facial-treatments?currentPage=1',
        'https://www.sephora.com/shop/facial-treatments?currentPage=2',
        'https://www.sephora.com/shop/facial-treatments?currentPage=3',
        'https://www.sephora.com/shop/facial-treatments?currentPage=4',
        'https://www.sephora.com/shop/facial-treatments?currentPage=5',
        'https://www.sephora.com/shop/facial-treatments?currentPage=6',
        'https://www.sephora.com/shop/facial-treatments?currentPage=7',
        'https://www.sephora.com/shop/facial-treatments?currentPage=8',
        'https://www.sephora.com/shop/facial-treatments?currentPage=9',
        'https://www.sephora.com/shop/facial-treatments?currentPage=10',
    ]
