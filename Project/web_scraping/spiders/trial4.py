...
class Trial4Spider(scrapy.Spider):
    name = 'trial4'
    ...
    start_urls = [
        'https://www.sephora.com/shop/cleanser?currentPage=1',
        'https://www.sephora.com/shop/cleanser?currentPage=2',
        'https://www.sephora.com/shop/cleanser?currentPage=3',
        'https://www.sephora.com/shop/cleanser?currentPage=4',
        'https://www.sephora.com/shop/cleanser?currentPage=5',
        'https://www.sephora.com/shop/cleanser?currentPage=6',
        'https://www.sephora.com/shop/cleanser?currentPage=7',
        'https://www.sephora.com/shop/cleanser?currentPage=8'
        ]
