...
class EyesSpider(scrapy.Spider):
    name = 'eyes'
    #allowed_domains = ['www.sephora.com']
    #start_urls = ['https://www.sephora.com/shop/eye-treatment-dark-circle-treatment?currentPage=1']

    def start_requests(self):
        yield SeleniumRequest(
            url='https://www.sephora.com/shop/eye-treatment-dark-circle-treatment?currentPage=1',
            wait_time=3,
            screenshot=True,
            callback=self.parse
            )
    ...
    def parse(self, response):
        ...
        try:
            ...
            driver.save_screenshot('before_nextforeyes.png')
            sleep(4)
            next_button.click()
            sleep(7)
            print("before screenshot")
            driver.save_screenshot('last_foreyes.png')
